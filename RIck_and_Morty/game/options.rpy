...
define config.name = _("Rick and Morty")
...
define gui.about = _p("""
Это небольшая визуальная новелла, сделанная в сеттинге Рика и Морти.\n
Автор - Илья Аврамец (Avraam).\n
24.06.2022
""")
...
define build.name = "RIck_and_Morty"
...
define config.save_directory = "RIck_and_Morty-1655665170"
